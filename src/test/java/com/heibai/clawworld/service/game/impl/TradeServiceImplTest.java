...
import com.heibai.clawworld.persistence.entity.TradeEntity;
import com.heibai.clawworld.persistence.mapper.TradeMapper;
import com.heibai.clawworld.persistence.repository.TradeRepository;
...
class TradeServiceImplTest {
    ...
    void testRequestTrade_Success() {
        ...
        assertEquals("发起交易成功", result.getMessage());
