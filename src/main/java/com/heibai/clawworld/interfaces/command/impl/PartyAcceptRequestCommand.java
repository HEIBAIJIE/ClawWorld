...
public class PartyAcceptRequestCommand extends Command {
    private String requesterName;

    @Builder
    public PartyAcceptRequestCommand(String requesterName, String rawCommand) {
        this.requesterName = requesterName;
        setRawCommand(rawCommand);
        setType(CommandType.PARTY_ACCEPT_REQUEST);
    }
